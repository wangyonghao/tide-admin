 ...
 * @see BizException
 */
public class Check extends Validator {

    private static final Class<BizException> EXCEPTION_TYPE = BizException.class;
     ...
     * @param params   参数值
     */
    public static void isNull(Object obj, String template, Object... params) {
     ...
     * @param params   参数值
     */
    public static void notBlank(CharSequence str, String template, Object... params) {
     ...
     *
     * @param condition       条件
     * @param messageTemplate 异常信息模板，被替换的部分用 {} 表示，如果模板为 null，返回 "null"
     * @param params          参数值
     */
