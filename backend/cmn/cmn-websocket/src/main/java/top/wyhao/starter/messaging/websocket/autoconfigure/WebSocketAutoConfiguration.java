...
import top.wyhao.starter.messaging.websocket.dao.WebSocketSessionDaoDefaultImpl;
...
public class WebSocketAutoConfiguration {
    ...
    public WebSocketHandler webSocketHandler(WebSocketSessionDao webSocketSessionDao) {
        return new top.wyhao.starter.messaging.websocket.core.WebSocketHandler(properties, webSocketSessionDao);
    }
