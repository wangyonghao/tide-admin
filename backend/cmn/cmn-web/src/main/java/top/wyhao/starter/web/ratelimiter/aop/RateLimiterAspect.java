...
package top.wyhao.starter.web.ratelimiter.aop;
...
import top.wyhao.starter.web.ratelimiter.exception.RateLimiterException;
...
public class RateLimiterAspect {
    ...
    private static final String CACHE_KEY_PREFIX = "rate-limiter:";
    ...
    public RateLimiterAspect(RateLimiterNameGenerator nameGenerator,
     ...
     * 单个限流注解切点
     */
    @Pointcut("@annotation(top.wyhao.starter.web.ratelimiter.annotation.RateLimiter)")
     ...
     * 多个限流注解切点
     */
    @Pointcut("@annotation(top.wyhao.starter.web.ratelimiter.annotation.RateLimiters)")
    ...
    private String getCacheKey(JoinPoint joinPoint, RateLimiter rateLimiter) {
        ...
        return RedisUtils.formatKey(CACHE_KEY_PREFIX, name, key, suffix);
    }
