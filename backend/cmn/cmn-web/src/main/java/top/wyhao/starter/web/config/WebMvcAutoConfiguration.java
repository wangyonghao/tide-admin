...
import top.wyhao.starter.web.aspect.PreventDuplicateSubmitAspect;
...
public class WebMvcAutoConfiguration implements WebMvcConfigurer {
     ...
     */
    @Bean
    public PreventDuplicateSubmitAspect preventRepeatAspect() {
    ...
    public void postConstruct() {
        log.debug("[wyhao-starter] - 'WebMvc' configured.");
    }
}
