...
VALUES (1000, '系统管理', 0, 1, '/system', 'Layout', '/system/user', 'lucide:settings-2', FALSE, FALSE, FALSE, NULL, 1,
       ...
       (1150, '系统配置', 1000, 2, '/system/config', 'system/config/index', NULL, 'lucide:settings', FALSE, FALSE,
        FALSE, NULL, 999, 1, 1, NOW()),
       (1160, '网站配置', 1150, 2, '/system/config?tab=site', 'system/config/site/index', NULL, 'apps', FALSE, FALSE,
        TRUE, NULL, 1, 1, 1, NOW()),
       (1161, '查询', 1160, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'system:siteConfig:get', 1, 1, 1, NOW()),
       (1162, '修改', 1160, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'system:siteConfig:update', 2, 1, 1, NOW()),
