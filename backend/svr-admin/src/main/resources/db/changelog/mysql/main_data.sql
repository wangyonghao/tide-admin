...
(1191, '查询', 1190, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'system:mailAccount:get', 1, 1, 1, NOW()),
(1192, '修改', 1190, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'system:mailAccount:update', 2, 1, 1, NOW()),
...
(`id`, `username`, `nickname`, `password`, `gender`, `email`, `phone`, `avatar`, `description`, `status`, `is_builtin`, `pwd_reset_time`, `dept_id`, `create_user`, `create_time`)
VALUES
...
(`dict_type`, `value`, `label`, `extra`, `sort`, `enabled`, `description`)
VALUES
('notice_type', '1', '产品新闻', '{"color": "primary"}', 1, 1, NULL),
('notice_type', '2', '企业动态', '{"color": "success"}', 2, 1, NULL),
('client_type', 'PC', '桌面端', '{"color": "primary"}', 1, 1, NULL),
('client_type', 'ANDROID', '安卓', '{"color": "success"}', 2, 1, NULL),
('client_type', 'XCX', '小程序', '{"color": "warning"}', 3, 1, NULL),
('sms_supplier', 'alibaba', '阿里云', '{"color": "warning"}', 1, 1, NULL),
('sms_supplier', 'tencent', '腾讯云', '{"color": "primary"}', 2, 1, NULL),
('sms_supplier', 'cloopen', '容联云', '{"color": "success"}', 3, 1, NULL);
