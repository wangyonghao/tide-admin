...
public class GlobalExceptionHandler {
    ...
    public Result<Map<String, Object>> handleOtpException(OtpException e, HttpServletRequest request) {
    ...
    public Result<Void> handleMissingServletRequestParameterException(MissingServletRequestParameterException e, HttpServletRequest request) {
        ...
        return Result.fail(String.valueOf(HttpStatus.BAD_REQUEST.value()), "参数 '%s' 缺失".formatted(e.getParameterName()));
    }
    ...
    public Result<Void> handleHttpMessageNotReadableException(HttpMessageNotReadableException e, HttpServletRequest request) {
        ...
        if (e.getCause() instanceof InvalidFormatException invalidFormatException) {
            return Result.fail(String.valueOf(HttpStatus.BAD_REQUEST.value()), "参数 '%s' 类型不匹配"
                .formatted(invalidFormatException.getValue()));
        }
        return Result.fail(String.valueOf(HttpStatus.BAD_REQUEST.value()), "参数缺失或格式不正确");
    }
    ...
    public Result<Void> handleMultipartException(MultipartException e, HttpServletRequest request) {
        ...
        Result<Void> defaultFail = Result.fail(String.valueOf(HttpStatus.BAD_REQUEST.value()), msg);
        ...
        return Result.fail(String.valueOf(HttpStatus.BAD_REQUEST.value()), "请上传小于 %s 的文件".formatted(FileUtil
    ...
    public Result<Void> handleNoHandlerFoundException(NoHandlerFoundException e, HttpServletRequest request) {
        log.error(CharSequenceUtil.format("[{}] {}", request.getMethod(), request.getRequestURI()), e);
        return Result.fail(String.valueOf(HttpStatus.NOT_FOUND.value()), "请求 URL '%s' 不存在".formatted(request
            .getRequestURI()));
    }
    ...
    public Result<Void> handleHttpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException e,
        ...
        log.error(CharSequenceUtil.format("[{}] {}", request.getMethod(), request.getRequestURI()), e);
        return Result.fail(String.valueOf(HttpStatus.METHOD_NOT_ALLOWED.value()), "请求方式 '%s' 不支持".formatted(e.getMethod()));
    }
    ...
    public Result<Void> handleConstraintViolationException(ConstraintViolationException e, HttpServletRequest request) {
        ...
        return Result.fail(HttpStatus.BAD_REQUEST.name(), "参数校验失败：" + msg);
    }
    ...
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public Result<Void> handleSystemException(Exception e, HttpServletRequest request) {
