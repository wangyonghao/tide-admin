...
import top.wyhao.admin.system.domain.bo.user.UserBasicInfoUpdateReq;
import top.wyhao.admin.system.domain.bo.user.UserEmailUpdateRequest;
import top.wyhao.admin.system.domain.bo.user.UserPasswordUpdateReq;
import top.wyhao.admin.system.domain.bo.user.UserPhoneUpdateReq;
import top.wyhao.admin.system.domain.entity.user.UserSocialDO;
import top.wyhao.admin.system.domain.enums.SocialSource;
import top.wyhao.admin.system.domain.vo.AvatarResp;
import top.wyhao.admin.system.domain.vo.user.UserSocialBindResp;
