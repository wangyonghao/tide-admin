...
package top.wyhao.admin.system.domain.bo;
...
import top.wyhao.admin.system.domain.enums.NoticeScopes;
import top.wyhao.admin.system.domain.enums.NoticeStatus;
...
public class NoticeReq implements Serializable {
    ...
    @SpelNotEmpty(condition = "#this.noticeScope == T(top.wyhao.admin.system.domain.enums.NoticeScopes).USER", message = "通知用户不能为空")
