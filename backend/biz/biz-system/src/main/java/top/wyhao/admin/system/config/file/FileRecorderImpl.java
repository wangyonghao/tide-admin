...
package top.wyhao.admin.system.config.file;
...
import top.wyhao.admin.system.mapper.StorageMapper;
import top.wyhao.admin.system.domain.entity.FileDO;
import top.wyhao.admin.system.domain.entity.StorageDO;
...
public class FileRecorderImpl implements FileRecorder {
    ...
    public boolean save(FileInfo fileInfo) {
        ...
        file.setStorageId(fileInfo.getPlatform());
